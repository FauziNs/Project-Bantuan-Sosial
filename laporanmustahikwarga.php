...
//CARI TAHU 1
$get = mysqli_query($c, "SELECT * FROM mustahik_warga WHERE idktwarga=4;");
...
//CARI TAHU 2
$get1 = mysqli_query($c, "SELECT * FROM mustahik_warga WHERE idktwarga=5;");

while ($p = mysqli_fetch_array($get1)) {
    $hakwarga1[] = $p['hakwarga'];


    $jml2 = array_sum($hakwarga1);
};
//CARI TAHU 3
$get2 = mysqli_query($c, "SELECT * FROM mustahik_warga WHERE idktwarga=6;");

while ($p = mysqli_fetch_array($get2)) {
    $hakwarga2[] = $p['hakwarga'];
...
$h1 = mysqli_query($c, "SELECT DISTINCT namawarga FROM mustahik_warga");
...
<body>
    ...
    <div class="container">
        ...
        <a class="btn btn-primary" href="docmw.php" role="button">Download Pdf</a>


        <table class="table table-bordered table-striped mt-4">
            <thead>
                <th colspan="1">Miskin - Hak Kg</th>
                <th colspan="1">Fakir - Hak Kg</th>
                <th colspan="1">Mampu - Hak Kg</th>
                <tr>
                    <td>Total Beras</td>
                    <td>Total Beras</td>
                    <td>Total Beras</td>
